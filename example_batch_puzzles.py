import os
from sudoku_solver_opt import create_solveable_board, create_solution,random_board
...
for i in range(limit+1):
    board = create_solveable_board(filling_degree,f".//generated_puzzles//puzzle_{i:04d}.txt")
